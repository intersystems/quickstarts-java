...
* 4. Choose option 5 to the print the version of InterSystems IRIS by directly calling a routine within InterSystems IRIS
*/
...
public class nativeplaystocksTask5 {
	...
	public static HashMap<String, String> getConfig(String filename) throws FileNotFoundException, IOException{
        ...
        BufferedReader reader = new BufferedReader(new InputStreamReader(nativeplaystocksTask5.class.getResourceAsStream(filename)));
