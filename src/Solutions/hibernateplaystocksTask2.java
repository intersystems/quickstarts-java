/*
* PURPOSE: This example shows using Hibernate, a third-party ORM tool, to generate trade
*
* NOTES: When running the application: Choose option 1 to generate trade
*/
