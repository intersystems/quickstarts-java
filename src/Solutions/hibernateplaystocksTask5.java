/*
* PURPOSE: This example shows using Hibernate, a third-party ORM tool, to view all traders by last name
*
...
public class hibernateplaystocksTask5 {
    ...
    protected void deleteAll() {
    	...
    	session.createQuery("delete from Solutions.Demo.Trade").executeUpdate();
