 ...
 *
 * NOTES: When running the application: Choose option 3 to generate 10000 trades
 */
...
public class xepplaystocksTask3 {
	...
	public static HashMap<String, String> getConfig(String filename) throws FileNotFoundException, IOException{
		...
		BufferedReader reader = new BufferedReader(new InputStreamReader(xepplaystocksTask3.class.getResourceAsStream(filename)));
